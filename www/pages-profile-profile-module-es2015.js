...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = ("<ion-header>\n  <ion-toolbar>\n    <ion-buttons slot=\"start\">\n      <ion-menu-button autoHide=\"false\"></ion-menu-button>\n\n    </ion-buttons>\n    <ion-buttons slot=\"secondary\">\n      <ion-button>\n        <ion-icon slot=\"icon-only\" name=\"star\"></ion-icon>\n      </ion-button>\n    </ion-buttons>\n    <ion-title>Profile</ion-title>\n  </ion-toolbar>\n</ion-header>\n\n<ion-content>\n  <ion-avatar>\n    <img [src]=\"cliente?.imageUrl || '/assets/imgs/avatar-blank.png'\" alt=\"profile\">\n  </ion-avatar>\n  <h2 text-center>{{cliente?.nome}}</h2>\n  <p text-center>{{cliente?.email}}</p>\n\n  <ion-card>\n    <ion-card-header> Enviar imagem de perfil </ion-card-header>\n    <ion-item *ngIf=\"picture\"> <img [src]=\"picture\"> </ion-item>\n\n    <ion-button (click)=\"getCameraPicture()\" expand=\"block\" [disabled]=\"cameraOn\">Camera</ion-button>\n    <ion-button (click)=\"getGalleryPicture()\" expand=\"block\" [disabled]=\"cameraOn\">Gallery</ion-button>\n    <ion-button *ngIf=\"picture\" fill=\"outline\" expand=\"block\" (click)=\"sendPicture()\">Enviar imagem</ion-button>\n    <ion-button *ngIf=\"picture\" fill=\"outline\" expand=\"block\" (click)=\"cancel()\">Descartar imagem</ion-button>\n  </ion-card>\n\n</ion-content>");
...
/* harmony import */ var _profile_routing_module__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./profile-routing.module */ "./src/pages/profile/profile-routing.module.ts");
/* harmony import */ var _profile_page__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./profile.page */ "./src/pages/profile/profile.page.ts");
...
ProfilePageModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["NgModule"])({
        ...
        providers: [_ionic_native_camera_ngx__WEBPACK_IMPORTED_MODULE_4__["Camera"]],
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = (".circle {\n  width: 60%;\n  border-radius: 100%;\n  margin: 25px auto 0 auto;\n}\n/*# sourceMappingURL=data:application/json;base64, */");
...
/* harmony import */ var src_services_domain_cliente_service__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! src/services/domain/cliente.service */ "./src/services/domain/cliente.service.ts");
/* harmony import */ var src_services_storage_service__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! src/services/storage.service */ "./src/services/storage.service.ts");
...
let ProfilePage = class ProfilePage {
    constructor(router, domSanitizer, clienteService, storageService) {
        this.router = router;
    ...
    loadData() {
        ...
        if (localUser && localUser.email) {
            this.clienteService.findByEmail(localUser.email).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_6__["tap"])(response => this.cliente = response), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_6__["tap"])(() => this.cliente.imageUrl = `${src_environments_environment__WEBPACK_IMPORTED_MODULE_7__["environment"].BUCKET_URL}/cp${this.cliente.id}.jpg`), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_6__["catchError"])(error => {
                if (error.status) {
                    this.router.navigateByUrl('/');
                }
                return new rxjs__WEBPACK_IMPORTED_MODULE_5__["Observable"]();
            }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_6__["take"])(1)).subscribe();
        }
        else
            this.router.navigateByUrl('/');
    }
    ...
    sendPicture() {
        this.clienteService.uploadPicture(this.picture).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_6__["tap"])(() => this.picture = null), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_6__["tap"])(() => this.loadData())).subscribe();
    }
    cancel() {
        this.picture = null;
    }
...
ProfilePage.ctorParameters = () => [
    ...
    { type: src_services_domain_cliente_service__WEBPACK_IMPORTED_MODULE_8__["ClienteService"] },
    { type: src_services_storage_service__WEBPACK_IMPORTED_MODULE_9__["StorageService"] }
];
